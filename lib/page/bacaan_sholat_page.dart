...
class _BacaanSholatState extends State<BacaanSholat> {
  Future<List<ModelBacaan>> ReadJsonData() async {
    final jsondata =
        await rootBundle.rootBundle.loadString('assets/data/bacaan_sholat.json');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 140, 184, 252),
      body: SafeArea(
        child: Column(
              ...
              children: [
                Align(
                  ...
                  child: IconButton(
                    ...
                    icon: const Icon(Icons.arrow_back, color: Color.fromARGB(255, 177, 61, 255)),
                  ),
                ),
                Align(
                  alignment: Alignment.topLeft,
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: Color.fromARGB(255, 65, 114, 247)),
                    height: 200,
